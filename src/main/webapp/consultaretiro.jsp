        ...
        <span class="navbar-toggler-icon"></span>
			...
			<!-- CONTENEDOR MATRICULA -->
				<div class="container-fluid matricula-container"
					id="consultaRetiro">
					<div class="row">
						<h3 class="tittle-matricula">Consulta Retiro</h3>
						<div class="col-md-4">
							...
							<div class="col-lg-6">
								...
								<form action="MatriculaServlet?type=registrar" method="post"
									...
									<div class="form-group matricula-group">
										<label class="label-matricula">C�digo de Alumno</label> <input
											class="form-control" type="number"
											value="${alumn.idAlumno}" name="txtIdAlumno"
											id="txtIdAlumno">
							...
							<div class="col-12">
								<div class="col-12" id="tabla1">
									<table id="miTabla" class="table table-success table-striped">
										<thead>
											<tr>
												<th class="centered">Numero de Retiro</th>
												<th class="centered">Nombre Matricula</th>
										...
										<tbody>
											<%
											List<Retiro> listRetiro = (List<Retiro>) request.getAttribute("listReti");
											if (listRetiro != null) {
												for (Retiro r : listRetiro) {
											%>
											<tr>
												<td><%=r.getNumRetiro()%></td>
												<td><%=r.getNumMatricula()%></td>
												<td><%=r.getFecha()%></td>
												<td><%=r.getHora()%></td>
